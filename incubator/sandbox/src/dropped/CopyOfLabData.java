...
public class CopyOfLabData {

	public class LabEntityX {
		DustEntity e;
		String name;
		final String typeName;

		LabEntityX(DustEntity e) {
			this("?", e);
		}

		LabEntityX(String typeName, DustEntity e) {
	...
	public class LabUnit extends LabEntityX {
	...
	public class LabType extends LabEntityX {
	...
	ArrayList<LabEntityX> alEntities;
	...
	public CopyOfLabData() {
		...
		alEntities = new ArrayList<LabEntityX>();
	...
	public LabEntityX addEntity() throws Exception {
		LabEntityX e = new LabEntityX(DustUtils.getEntity(null, null));
