...
public class TestInitTypeManagement extends TestItem {
	...
	public void test() throws Exception {
		...
		fld1 = DustUtils.getEntity(idField, new DustVariant[] {
			world.getVar(null, Common.Identified.Fields.Identifier, TypeManagement.FieldValue.Fields.Ordinal.name()),
			world.getVar(null, TypeManagement.Field.Fields.FieldType, TypeManagement.Field.Values.FieldType.Long),
		});
		...
		DustEntity eTypeFieldValue = DustUtils.getEntity(idType, new DustVariant[] {
			...
			world.getVar(null, TypeManagement.Type.Fields.Fields, new DustUtilInitValue[] {
		...
		fld1 = DustUtils.getEntity(idField, new DustVariant[] {
			world.getVar(null, Common.Identified.Fields.Identifier, TypeManagement.Shared.Fields.ObType.name()),
		...
		fld1 = DustUtils.getEntity(idField, new DustVariant[] {
			world.getVar(null, Common.Identified.Fields.Identifier, TypeManagement.Shared.Fields.ObType.name()),
			world.getVar(null, TypeManagement.Field.Fields.FieldType, TypeManagement.Field.Values.FieldType.ObMap),
		...
		fld1 = DustUtils.getEntity(idField, new DustVariant[] {
			world.getVar(null, Common.Identified.Fields.Identifier, TypeManagement.Field.Fields.FieldType.name()),
			...
			world.getVar(null, TypeManagement.Field.Fields.Values, new DustUtilInitValue[] {
				new DustUtilInitValue(DustUtils.getEntity(idFieldValue, new DustVariant[] {
					world.getVar(null, Common.Identified.Fields.Identifier, TypeManagement.Field.Values.FieldType.Identifier.name()),
					world.getVar(null, TypeManagement.FieldValue.Fields.Ordinal, 0),
				})), new DustUtilInitValue(DustUtils.getEntity(idFieldValue, new DustVariant[] {
					world.getVar(null, Common.Identified.Fields.Identifier, TypeManagement.Field.Values.FieldType.String.name()),
					world.getVar(null, TypeManagement.FieldValue.Fields.Ordinal, 1),
				})), new DustUtilInitValue(DustUtils.getEntity(idFieldValue, new DustVariant[] {
					world.getVar(null, Common.Identified.Fields.Identifier, TypeManagement.Field.Values.FieldType.Long.name()),
					world.getVar(null, TypeManagement.FieldValue.Fields.Ordinal, 2),
				})), new DustUtilInitValue(DustUtils.getEntity(idFieldValue, new DustVariant[] {
					world.getVar(null, Common.Identified.Fields.Identifier, TypeManagement.Field.Values.FieldType.Double.name()),
					world.getVar(null, TypeManagement.FieldValue.Fields.Ordinal, 3),
				})), new DustUtilInitValue(DustUtils.getEntity(idFieldValue, new DustVariant[] {
					world.getVar(null, Common.Identified.Fields.Identifier, TypeManagement.Field.Values.FieldType.ImmutableDate.name()),
					world.getVar(null, TypeManagement.FieldValue.Fields.Ordinal, 4),
				})), new DustUtilInitValue(DustUtils.getEntity(idFieldValue, new DustVariant[] {
					world.getVar(null, Common.Identified.Fields.Identifier, TypeManagement.Field.Values.FieldType.Boolean.name()),
					world.getVar(null, TypeManagement.FieldValue.Fields.Ordinal, 5),
				})), new DustUtilInitValue(DustUtils.getEntity(idFieldValue, new DustVariant[] {
					world.getVar(null, Common.Identified.Fields.Identifier, TypeManagement.Field.Values.FieldType.ValueSet.name()),
					world.getVar(null, TypeManagement.FieldValue.Fields.Ordinal, 6),
				})), new DustUtilInitValue(DustUtils.getEntity(idFieldValue, new DustVariant[] {
					world.getVar(null, Common.Identified.Fields.Identifier, TypeManagement.Field.Values.FieldType.ByteArray.name()),
					world.getVar(null, TypeManagement.FieldValue.Fields.Ordinal, 7),
				})), new DustUtilInitValue(DustUtils.getEntity(idFieldValue, new DustVariant[] {
					world.getVar(null, Common.Identified.Fields.Identifier, TypeManagement.Field.Values.FieldType.ObType.name()),
					world.getVar(null, TypeManagement.FieldValue.Fields.Ordinal, 8),
				})), new DustUtilInitValue(DustUtils.getEntity(idFieldValue, new DustVariant[] {
					world.getVar(null, Common.Identified.Fields.Identifier, TypeManagement.Field.Values.FieldType.ObSingle.name()),
					world.getVar(null, TypeManagement.FieldValue.Fields.Ordinal, 9),
				})), new DustUtilInitValue(DustUtils.getEntity(idFieldValue, new DustVariant[] {
					world.getVar(null, Common.Identified.Fields.Identifier, TypeManagement.Field.Values.FieldType.ObSet.name()),
					world.getVar(null, TypeManagement.FieldValue.Fields.Ordinal, 10),
				})), new DustUtilInitValue(DustUtils.getEntity(idFieldValue, new DustVariant[] {
					world.getVar(null, Common.Identified.Fields.Identifier, TypeManagement.Field.Values.FieldType.ObArray.name()),
					world.getVar(null, TypeManagement.FieldValue.Fields.Ordinal, 11),
				})), new DustUtilInitValue(DustUtils.getEntity(idFieldValue, new DustVariant[] {
					world.getVar(null, Common.Identified.Fields.Identifier, TypeManagement.Field.Values.FieldType.ObMap.name()),
		...
		fld2 = DustUtils.getEntity(idField, new DustVariant[] {
			world.getVar(null, Common.Identified.Fields.Identifier, TypeManagement.Field.Fields.ObType.name()),
		...
		fld3 = DustUtils.getEntity(idField, new DustVariant[] {
			world.getVar(null, Common.Identified.Fields.Identifier, TypeManagement.Field.Fields.Values.name()),
			world.getVar(null, TypeManagement.Field.Fields.FieldType, TypeManagement.Field.Values.FieldType.ObMap),
		...
		fld1 = DustUtils.getEntity(idField, new DustVariant[] {
			world.getVar(null, Common.Identified.Fields.Identifier, TypeManagement.Message.Fields.Fields.name()),
			world.getVar(null, TypeManagement.Field.Fields.FieldType, TypeManagement.Field.Values.FieldType.ObMap),
			world.getVar(null, TypeManagement.Field.Fields.ObType, idField.getIdentifier()),
		});
		...
		fld1 = DustUtils.getEntity(idField, new DustVariant[] {
			world.getVar(null, Common.Identified.Fields.Identifier, TypeManagement.Module.Fields.Vendor.name()),
			world.getVar(null, TypeManagement.Field.Fields.FieldType, TypeManagement.Field.Values.FieldType.Identifier),
		});

		fld2 = DustUtils.getEntity(idField, new DustVariant[] {
			world.getVar(null, Common.Identified.Fields.Identifier, TypeManagement.Module.Fields.Domain.name()),
			world.getVar(null, TypeManagement.Field.Fields.FieldType, TypeManagement.Field.Values.FieldType.Identifier),
		});

		fld3 = DustUtils.getEntity(idField, new DustVariant[] {
			world.getVar(null, Common.Identified.Fields.Identifier, TypeManagement.Module.Fields.Version.name()),
			world.getVar(null, TypeManagement.Field.Fields.FieldType, TypeManagement.Field.Values.FieldType.Identifier),
		});

		shared1 = DustUtils.getEntity(idShared, new DustVariant[] {
			world.getVar(null, Common.Identified.Fields.Identifier, TypeManagement.Module.Shared.Kernel.name()),
		...
		fld1 = DustUtils.getEntity(idField, new DustVariant[] {
			world.getVar(null, Common.Identified.Fields.Identifier, TypeManagement.Type.Fields.Unit.name()),
			world.getVar(null, TypeManagement.Field.Fields.FieldType, TypeManagement.Field.Values.FieldType.Identifier),
		});
		fld2 = DustUtils.getEntity(idField, new DustVariant[] {
			world.getVar(null, Common.Identified.Fields.Identifier, TypeManagement.Type.Fields.Fields.name()),
			world.getVar(null, TypeManagement.Field.Fields.FieldType, TypeManagement.Field.Values.FieldType.ObSet),
			world.getVar(null, TypeManagement.Field.Fields.ObType, idField.getIdentifier()),
		});
		fld3 = DustUtils.getEntity(idField, new DustVariant[] {
			world.getVar(null, Common.Identified.Fields.Identifier, TypeManagement.Type.Fields.Messages.name()),
			world.getVar(null, TypeManagement.Field.Fields.FieldType, TypeManagement.Field.Values.FieldType.ObSet),
		...
		fld4 = DustUtils.getEntity(idField, new DustVariant[] {
			world.getVar(null, Common.Identified.Fields.Identifier, TypeManagement.Type.Fields.Shared.name()),
			world.getVar(null, TypeManagement.Field.Fields.FieldType, TypeManagement.Field.Values.FieldType.ObSet),
		...
		fld5 = DustUtils.getEntity(idField, new DustVariant[] {
			world.getVar(null, Common.Identified.Fields.Identifier, TypeManagement.Type.Fields.Resource.name()),
			world.getVar(null, TypeManagement.Field.Fields.FieldType, TypeManagement.Field.Values.FieldType.ObSet),
			world.getVar(null, TypeManagement.Field.Fields.ObType, idResource.getIdentifier()),
		});
		shared1 = DustUtils.getEntity(idShared, new DustVariant[] {
			world.getVar(null, Common.Identified.Fields.Identifier, TypeManagement.Type.Shared.Self.name()),
